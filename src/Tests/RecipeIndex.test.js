...
describe('RecipeIndex Component', () => {
  it('renders 3 <RecipeCard /> components', () => {
        ...
        recipes={[
          {
            ...
            image:
              'https://live.staticflickr.com/2376/5799408683_9cc6ffc686_b.jpg',
          },
          {
            ...
            image:
              'https://live.staticflickr.com/4778/40733751321_2ec04268f7_b.jpg',
          },
          {
    ...
    expect(wrapper.find('cardwrapper'));
  });
});
